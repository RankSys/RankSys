...
public class CompressionExample {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        FastUserIndex<Long> users = SimpleFastUserIndex.load(readUsers(new FileInputStream(userPath)));
        FastItemIndex<Long> items = SimpleFastItemIndex.load(readItems(new FileInputStream(itemPath)));
        FastPreferenceData<Long, Long> simpleData = SimpleFastPreferenceData.load(readPreferenceTuples(new FileInputStream(dataPath)), users, items);
